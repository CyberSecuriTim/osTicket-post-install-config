...
- NOTE: Upon login, if you are not automatically brought to the admin panel (and instead to the agent panel), simply click the "Admin Panel" link in the top right corner to be redirected to the admin panel in order to complete the outlined configuration objectives. 
